...
export const ConsentForm = (props) => {
    ...
    function parseTable(tableData) {
        ...
        const description = tableData.description !== undefined
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", Object.assign({ className: 'max-w-3xl' }, { children: _jsx(BodyLarge, { text: description }) })), _jsxs("div", Object.assign({ className: 'flex flex-col gap-16 w-full' }, { children: [_jsx("div", Object.assign({ className: 'grid gap-4 md:gap-8 max-w-full' }, { children: tables.map((table) => {

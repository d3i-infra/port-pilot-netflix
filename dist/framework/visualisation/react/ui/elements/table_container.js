...
export const TableContainer = ({ id, table, updateTable, locale }) => {
    ...
    return (_jsx("div", Object.assign({ className: 'p-3 md:p-4 lg:p-6 flex flex-col gap-4 w-full overflow-hidden border-[0.2rem] border-grey4 rounded-lg' }, { children: _jsxs("div", Object.assign({ className: 'flex flex-wrap ' }, { children: [_jsxs("div", Object.assign({ className: 'flex sm:flex-row justify-between w-full gap-1 mb-2' }, { children: [_jsx(Title4, { text: table.title, margin: '' }), unfilteredRows > 0
                            ? (_jsx(SearchBar, { placeholder: text.searchPlaceholder, search: search, onSearch: setSearch }))
                            : null] }), 'Title'), _jsx("div", Object.assign({ className: 'flex flex-col w-full mb-2 text-base md:text-lg font-body max-w-2xl' }, { children: _jsx("p", { children: table.description }) }), 'Description'), _jsxs("div", Object.assign({ className: 'flex items-center justify-between w-full mt-1 pt-1 rounded ' }, { children: [_jsx(TableItems, { table: table, searchedTable: searchedTable, handleUndo: handleUndo, locale: locale }), _jsxs("button", Object.assign({ className: `flex end gap-3 animate-fadeIn ${unfilteredRows === 0 ? 'hidden' : ''}`, onClick: () => setShow(!show) }, { children: [_jsx("div", Object.assign({ className: 'text-primary' }, { children: show ? zoomOutIcon : zoomInIcon }), 'zoomIcon'), _jsx("div", Object.assign({ className: 'text-right hidden md:block' }, { children: show ? text.hideTable : text.showTable }), 'zoomText')] }), show ? 'animate' : '')] }), 'TableSummary'), _jsx("div", Object.assign({ className: 'w-full' }, { children: _jsx("div", Object.assign({ className: '' }, { children: _jsx(Table, { show: show, table: searchedTable, search: search, unfilteredRows: unfilteredRows, handleDelete: handleDelete, handleUndo: handleUndo, locale: locale }) })) }), 'Table'), _jsx("div", Object.assign({ className: `pt-2 grid w-full gap-4 transition-all ${tableVisualizations.length > 0 && unfilteredRows > 0 ? '' : 'hidden'}` }, { children: tableVisualizations.map((vs, i) => {
                        return (_jsx(Figure, { table: searchedTable, visualization: vs, locale: locale, handleDelete: handleDelete, handleUndo: handleUndo }, table.id + '_' + String(i)));
